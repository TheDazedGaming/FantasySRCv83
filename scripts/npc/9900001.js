    ...
    if (mode < 1) {
        ...
        if (status == 0) 
            ...
            if (selection == 1) {
				...
				cm.sendOk("You currently have #r" + cm.getDonorPoints() + "#k Donor Points.");
				cm.dispose();
			}
			} else if (status == 2){
            if (beauty == 1){
