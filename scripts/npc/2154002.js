...
function action(mode, type, selection) {
        if (mode == -1) {
                ...
                if(status == 0) {
                        cm.sendNext("You must be #b#h ##k. I am Le Tierre#k, the Fantasy Point Exchange NPC here in Fantasy. I can exchange the Fantasy Points that" +
						" you have obtained for being online and leveling.");
                } else if (status == 1) {
						if (cm.getPlayer().getLevel() >= 50) {
						cm.sendSimple("Your Current Points are: #e#r"+ cm.getFantasyPoints() +"#k#n. Please check out what I offer in my categories below\r\n\r\n" +
